      ...
      <div className="2xl:container 2xl:mx-auto lg:py-16 lg:px-20 md:py-12 md:px-6 py-9 px-4">
        ...
        <div className="grid sm:grid-cols-3 grid-cols-2 sm:gap-8 gap-4">
          ...
          <div>
            ...
            <p className="font-normal text-base leading-6 mt-6">Sim, 1 Milhão. Essa é a soma do impacto de nosso trabalho. Em média, cada vídeo do nosso cliente bate 20k visualizações. </p>
          </div>
          <div>
            <p className="font-semibold lg:text-2xl text-xl lg:leading-6 leading-5  mt-6">+40 projetos 2022</p>
