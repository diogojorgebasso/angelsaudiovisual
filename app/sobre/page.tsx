      ...
      <section className="mb-32 text-center">
        ...
        <div className="grid gap-x-6 md:grid-cols-3 lg:gap-x-12">
          <div className="mb-6 lg:mb-0">
            ...
            >
              <div className="relative overflow-hidden bg-cover bg-no-repeat">
                <Image width={2000} height={500} alt="Imagem de rosto do diogo" src="/equipe/diogo-basso.jpg" className="w-full rounded-t-lg" />
                <a href="/sobre/equipe/diogo-basso">
              ...
              <div className="p-5">
                <h5 className=" text-lg font-bold">Diogo Jorge Basso</h5>
                <p className="mb-4 text-neutral-500 dark:text-neutral-300">Founder</p>
          ...
          <div className="mb-6 lg:mb-0">
            ...
            >
              <div className="relative overflow-hidden bg-cover bg-no-repeat">
                <Image alt="Foto de perfil da Geovana Crepaldi" height={200} width={200} src="" className="w-full rounded-t-lg" />
                <a href="#!">
                  <div className="absolute top-0 right-0 bottom-0 left-0 h-full w-full overflow-hidden bg-fixed" />
                </a>
                <svg
          ...
          <div className="">
            ...
            >
              <div className="relative overflow-hidden bg-cover bg-no-repeat">
                <Image alt="Imagem de perfil do Matheus Cândido, operador de drone" src="https://mdbcdn.b-cdn.net/img/new/avatars/15.jpg" className="w-full rounded-t-lg" />
                <a href="#!">
                  <div className="absolute top-0 right-0 bottom-0 left-0 h-full w-full overflow-hidden bg-fixed" />
                </a>
                <svg
