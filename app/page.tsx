          ...
          <div className="grid items-center gap-12 lg:grid-cols-2">
            <div className="mt-12 lg:mt-0">
              ...
              <div className="flex relative">
                ...
                <Image src="/clientes/giovanna-leone.jpeg" height={32} width={32} alt="Giovanna Leone, atual presidente do Albatroz" className="  -mx-2 rounded-full" />
                <Image src="/clientes/raquel-beyoha.jpeg" height={32} width={32} alt="Raquel Beyoha, atual presidente do EPA" className="z-10 -mx-2 rounded-full" />
