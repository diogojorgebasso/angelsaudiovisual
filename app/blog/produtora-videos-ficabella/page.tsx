...
export default function Page() {
  ...
  <main>
      ...
      <p>
        A produtora de vídeos FicaBella tem enfrentado uma significativa
        rotatividade de pessoal no setor administrativo, especificamente, no
        cargo de Assistente, considerado como pessoal de elevada competência na
        empresa. O setor de Recursos Humanos intensificou as entrevistas de
      ...
      <p>
        ...
        na função de Assistente ocorreu por que
      </p>
